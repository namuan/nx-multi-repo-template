...
public class TenantService {
    ...
    public TenantService(TenantRepository tenantRepo, DeviceRepository deviceRepo,
                         UserRepository userRepo, AuditLogService auditLog) {
    ...
    public Tenant updateTenant(UUID tenantId, String name, String logoUrl,
                               String primaryColor, UUID actorId, String actorEmail) {
        ...
        auditLog.record(tenantId, actorId, actorEmail, "TENANT_UPDATED",
                "tenant", tenantId.toString(), null, null);
        return tenant;
    }
    ...
    public Tenant suspendTenant(UUID tenantId, UUID actorId, String actorEmail) {
        ...
        tenant = tenantRepo.save(tenant);
        auditLog.record(tenantId, actorId, actorEmail, "TENANT_SUSPENDED",
                "tenant", tenantId.toString(), null, null);
        return tenant;
    }
